import os
import sys
sys.path.append('/home/guningquan/folding-unfolding/src/PyFlex/bindings/build')
os.environ['PYFLEXROOT'] = '/home/guningquan/folding-unfolding/src/PyFlex'
os.environ['PYTHONPATH'] = '/home/guningquan/folding-unfolding/src/PyFlex/bindings/build'
os.environ['LD_LIBRARY_PATH'] = '/home/guningquan/folding-unfolding/src/PyFlex/external/SDL2-2.0.4/lib/x64'
            ...
            def log_steps(output, steps, color=None):
                ...
                for k in steps:
                    for t in range(1):
                        ...
                        preaction_weighted_distance, preaction_cover_reward, \
                            preaction_icp_cost, _, _, preaction_clouds = deformable_distance(init_verts, preaction_verts, group.attrs['max_coverage'])
                        postaction_weighted_distance, postaction_cover_reward, \
                            postaction_icp_cost, _, _, postaction_clouds = deformable_distance(init_verts, postaction_verts, group.attrs['max_coverage'])

                        metrics['preaction_weighted_distance'] = preaction_weighted_distance
                        metrics['preaction_l2_dist'] = preaction_cover_reward
                        metrics['preaction_icp_cost'] = preaction_icp_cost

                        metrics['postaction_weighted_distance'] = postaction_weighted_distance
                        metrics['postaction_l2_dist'] = postaction_cover_reward
